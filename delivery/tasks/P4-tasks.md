...
> Phase: **4 — Desktop UI** · Status: **Not started** · Est: 18 ED
> Depends on: P1, P2, P3

---

## P4-T1 · Tauri v2 scaffold + IPC layer
...
## P4-T2 · Architecture ban test (UI)
...
## P4-T5 · Dashboard + repo management view
...
## P4-T6 · Branches view (scan + classify)
...
## P4-T7 · Plan preview + execute flow
...
## P4-T8 · Backup, diff, history, auth, settings views
...
## P4-T9 · e2e smoke + standalone verification
