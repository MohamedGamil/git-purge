...
.PHONY: all build check test test-desktop test-all clippy fmt run clean ui-dev install-desktop-deps desktop-dev desktop-build desktop-test desktop-test-rust build-all coverage bench
